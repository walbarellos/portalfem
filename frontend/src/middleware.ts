...
export const onRequest = defineMiddleware(async (context, next) => {
  ...
  response.headers.set(
    ...
    [
      ...
      "connect-src 'self' http://localhost:* https://femcultura.ac.gov.br https://vlibras.gov.br https://*.vlibras.gov.br https://cdn.jsdelivr.net",
      "media-src 'self' blob: data: http://localhost:*",
